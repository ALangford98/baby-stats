...
describe('AppHeader', () => {
  it('no longer displays the session code itself', () => {
    render(<AppHeader recoveryCode="ABCD123456" onSync={vi.fn()} onOpenHistory={vi.fn()} onOpenSettings={vi.fn()} />);
  ...
  it('runs a manual sync and reports success', async () => {
    ...
    render(<AppHeader recoveryCode="ABCD123456" onSync={onSync} onOpenHistory={vi.fn()} onOpenSettings={vi.fn()} />);
  ...
  it('calls onOpenHistory when the History button is tapped', async () => {
    ...
    render(<AppHeader recoveryCode="ABCD123456" onSync={vi.fn()} onOpenHistory={onOpenHistory} onOpenSettings={vi.fn()} />);
  ...
  it('calls onOpenSettings when the Settings button is tapped', async () => {
    ...
    render(<AppHeader recoveryCode="ABCD123456" onSync={vi.fn()} onOpenHistory={vi.fn()} onOpenSettings={onOpenSettings} />);
